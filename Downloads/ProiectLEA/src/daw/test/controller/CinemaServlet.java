...
public class CinemaServlet extends HttpServlet {
    ...
    protected void doGet(HttpServletRequest request, HttpServletResponse response)
        ...
        ArrayList<CinemaBean> cbean = CinemaDAO.getAll();
        
        request.setAttribute("cinema", cbean);
        RequestDispatcher dispatcher = getServletContext().getRequestDispatcher("/Header/menuBar.jsp");
